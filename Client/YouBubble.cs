...
namespace chat
{
    public partial class YouBubble : UserControl
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            GraphicsPath creatorPath = RoundedRectangle.Create(creator.ClientRectangle, 5, RoundedRectangle.RectangleCorners.All);
            creator.Region = new Region(creatorPath);
